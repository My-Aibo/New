import CookieAgent from "@/app/components/atoms/cookie-fun/cookie-agent";
import CookieTweet from "@/app/components/atoms/cookie-fun/cookie-tweet";
import {
  AgentData,
  ...
  searchTweets,
  TweetData,
} from "@/app/server/actions/cookie";
import { z } from "zod";
...
export const cookietools = {
  getAgentDetailsFromAddress: {
    ...
    requiredEnvVars: ["NEXT_PUBLIC_COOKIE_FUN_API_KEY"],
