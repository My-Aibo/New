...
import rawKnownAddresses from "../utils/known-addresses.json";
import { chunkArray } from "../utils/providers";
...
export const fetchHelius = async (method: HeliusMethod, params: object) => {
  try {
